// DefaultTabBar.tsx - Original tab bar implementation for Android and other platforms
...
export default function DefaultTabBar() {
  ...
  const Label = (key: "home" | "referral" | "swap" | "payments") =>
    ({ color }: { color: string }) => (
  ...
  return (
    <Tabs
      ...
      screenOptions={{
        // Deshabilitar detección automática de rutas
        unmountOnBlur: true,
        headerShown: false,
